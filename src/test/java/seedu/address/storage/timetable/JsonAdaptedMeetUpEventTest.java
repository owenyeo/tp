...
public class JsonAdaptedMeetUpEventTest {
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedMeetUpEvent datedEvent = new JsonAdaptedMeetUpEvent(null, VALID_TIMEBLOCK, VALID_DATE,
                false, new JsonAdaptedPerson(IDA));
    ...
    public void toModelType_invalidTimeBlock_throwsIllegalValueException() {
        JsonAdaptedMeetUpEvent datedEvent = new JsonAdaptedMeetUpEvent(VALID_NAME, INVALID_TIMEBLOCK, VALID_DATE,
                false, new JsonAdaptedPerson(ALICE));
    ...
    public void toModelType_nullTimeBlock_throwsIllegalValueException() {
        JsonAdaptedMeetUpEvent datedEvent = new JsonAdaptedMeetUpEvent(VALID_NAME, null, VALID_DATE,
                false, new JsonAdaptedPerson(HOON));
        String expectedMessage = MeetUpEvent.MESSAGE_CONSTRAINTS;
        assertThrows(IllegalValueException.class, expectedMessage, datedEvent::toModelType);
    }
    ...
    public void toModelType_invalidDateString_throwsIllegalValueException() {
        JsonAdaptedMeetUpEvent datedEvent = new JsonAdaptedMeetUpEvent(VALID_NAME, VALID_TIMEBLOCK, INVALID_DATE,
                false, new JsonAdaptedPerson(HOON));
