...
public class AddScheduleCommandTest {
    ...
    public void execute_validCCa_success() {
        ...
        AddScheduleCommand addScheduleCommand = new AddScheduleCommand("Basketball","cca", "Monday 1030 1130");
        String expectedMessage = MESSAGE_SUCCESS + ("\nCCA:\n" + "Basketball" + " " + "Monday 1030 1130" + " to " + newUser.getName());
    ...
    public void execute_validCca_friend_success() {
        ...
        AddScheduleCommand addScheduleCommand = new AddScheduleCommand("Basketball", "cca", Index.fromZeroBased(0), "Monday 1030 1130");
        String expectedMessage = MESSAGE_SUCCESS + ("\nCCA:\n" + "Basketball" + " " + "Monday 1030 1130" + " to " + friend.getName());
        Model expectedModel = new ModelManager(model.getAddressBook(),
                new UserPrefs(), new UserData());
        expectedModel.setUser(newUser);
    ...
    public void execute_validModule_success() {
        User newUser = new UserBuilder().build();
        model.setUser(newUser);
        AddScheduleCommand addScheduleCommand = new AddScheduleCommand("CS2103", "module", "Monday 1030 1130");
        String expectedMessage = MESSAGE_SUCCESS + "\nModule:\n" + "CS2103" + " " + "Monday 1030 1130" + " to " + newUser.getName();
    ...
    public void execute_validModuleFriend_success() {
        ...
        model.setUser(newUser);
        Person friend = model.getFilteredPersonList().get(0);
        AddScheduleCommand addScheduleCommand = new AddScheduleCommand("CS2103", "module", Index.fromZeroBased(0), "Monday 1030 1130");
        String expectedMessage = MESSAGE_SUCCESS + "\nModule:\n" + "CS2103" + " " + "Monday 1030 1130" + " to " + friend.getName();
    ...
    public void execute_invalidEventType_failure() {
        User newUser = new UserBuilder().build();
        model.setUser(newUser);
        AddScheduleCommand addScheduleCommand = new AddScheduleCommand("CS2103", "sleep", "Monday 1030 1130");
